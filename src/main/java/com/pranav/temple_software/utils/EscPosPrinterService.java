...
public class EscPosPrinterService {
	...
	private static final Font FONT_ITALIC_BOLD = new Font("Noto Sans Kannada", Font.ITALIC | Font.BOLD, 20);
	...
	private List<BufferedImage> buildFooter() {
		...
		footerLines.add(renderTextToImage("ಶ್ರೀ ದೇವರ ಕೃಪೆ ಸದಾ ನಿಮ್ಮ ಮೇಲಿರಲಿ!", FONT_ITALIC_BOLD, EscPos.Justification.Center));
		return footerLines;
	}
	...
	private BufferedImage renderDetailLine(String label, String value) {
		...
		g2d.setFont(EscPosPrinterService.FONT_BOLD);
